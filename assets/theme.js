  ...
  theme.PopupQuickView = function() {
      ...
      PopupQuickView.prototype = $.extend({}, PopupQuickView.prototype, {
          load: function() {
              ...
              if(theme.product.page_layout == '2') {
                  loader_require_arr.push({type: 'scripts', name: 'tabs'});
              }
              ...
              theme.Popups.addHandler(this.settings.popup_name, 'call.visible', function($popup, $target) {
                  ...
                  function() {
                      _.getProduct($product, function (data) {
                          ...
                          if(theme.Tabs) {
                              theme.Tabs.init($content.find('.js-tabs'));
                          }
                  ...
                  $countdown.each(function () {
                      ...
                      if(date_obj.getTime() - new Date().getTime() <= 0) {
                          if(theme.isThemeDemo) {
                              ...
                              dateNow.setDate(Math.max(dateNow.getDate() + 3, date_obj.getDate()));
                              dateNow.setHours(date_obj.getHours());
                              dateNow.setMinutes(date_obj.getMinutes() + 20);
                              dateNow.setSeconds(date_obj.getSeconds() - 1);
                              date_obj = dateNow;
                          } else {
